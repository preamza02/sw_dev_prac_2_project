...
export class BookingsApi extends runtime.BaseAPI {
   ...
   * Get all bookings
   */
  async bookingsGetRaw(
    requestParameters: BookingsGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetBookings200Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetBookings200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async bookingsGet(
    requestParameters: BookingsGetRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetBookings200Response> {
   ...
   * Delete a booking
   */
  async bookingsIdDeleteRaw(
    requestParameters: BookingsIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<DeleteBooking200Response>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DeleteBooking200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Delete a booking
   */
  async bookingsIdDelete(
    requestParameters: BookingsIdDeleteRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<DeleteBooking200Response> {
   ...
   */
  async bookingsIdGetRaw(
    requestParameters: BookingsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GetBookingById200Response>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetBookingById200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async bookingsIdGet(
    requestParameters: BookingsIdGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<GetBookingById200Response> {
   ...
   * Update a booking
   */
  async bookingsIdPutRaw(
    requestParameters: BookingsIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<UpdateBooking200Response>> {
    if (requestParameters['id'] == null) {
      throw new runtime.RequiredError(
        'id',
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UpdateBooking200ResponseFromJSON(jsonValue),
    );
  }
  ...
  async bookingsIdPut(
    requestParameters: BookingsIdPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<UpdateBooking200Response> {
   ...
   */
  async hotelsHotelIdBookingsPostRaw(
    requestParameters: HotelsHotelIdBookingsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<CreateBooking200Response>> {
    if (requestParameters['hotelId'] == null) {
      throw new runtime.RequiredError(
        'hotelId',
    ...
    const response = await this.request(
      {
        path: `/hotels/{hotelId}/bookings`.replace(
          `{${'hotelId'}}`,
          encodeURIComponent(String(requestParameters['hotelId'])),
        ),
        method: 'POST',
        headers: headerParameters,
        query: queryParameters,
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      CreateBooking200ResponseFromJSON(jsonValue),
    );
  }
   ...
   * Create a booking for a hotel
   */
  async hotelsHotelIdBookingsPost(
    requestParameters: HotelsHotelIdBookingsPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<CreateBooking200Response> {
